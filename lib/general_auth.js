...
class SessionManager extends AppLifeCycle {
    ...
    app_set_user_cookie(session_token) {
            ...
            if ( transtionObj ) {
                if ( transtionObj.user_op === 'login' ) {
                    ...
                    if ( user ) {
                        ...
                        //
                        this.app_set_user_cookie(res,session_token)   // leave it to the app to manage this construct, perhaps express, perhaps not
                        //
                        let elements = {}
                        let app_sess_data_access = this.sess_data_accessor()
