...
// 4) the sdb - a static data base. The static db is expected to be faily similar to a persistence DB, except that it offers the 
//      -- guarantee that the data items are stored on a disk local to the process access the code. (This is mostly used to 
