                    ...
                    switch ( cmd_pars.db_type ) {
                        case "key_value_db" : {
                            if ( cmd_pars.change === true ) {
                                await this.db.change_key_value_db_instance(initialized_db,conf)
                            }   
                            break;
                        }
                        case "session_key_value_db" : {
                            if ( cmd_pars.change === true ) {
                                await this.db.change_session_key_value_db_instance(initialized_db,conf)
                            }   
                            break;
                        }
                        case "static_db" : {
                            if ( cmd_pars.change === true ) {
                                await this.db.change_static_key_value_db_instance(initialized_db,conf)
                            }  
                            break;
                        }
                        case "persistence_db" : {
                            if ( cmd_pars.change === true ) {
                                await this.db.change_persistence_db_instance(initialized_db,conf)
                            }   
                            break;
                        }
                        case "admin_relays" : {
