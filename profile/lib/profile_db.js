...
class ProfileDBClass extends DBClass {
    ...
    constructor() {
      ...
      g_persistence.message_fowarding.subscribe('user-profile',{ "source" : "dashboad", "m_path" : "persistence" },asset_intake)
      //
    ...
    asset_intake(obj) {   // This object has not been put into static store by the backend. the backned created the file and sent it.
      ...
      let dash_obj = decodeURIComponent(obj.profile) //
      try {
      ...
      dash_obj.which_profile = random_enough_dash_id()
      //
      let extension = {}
       ...
       G_profile_trns.update(extension)  // get further refinement by custom data operators.'
